...
?>
	...
	<div class="ai-grid ai-cols-2">
		<div>
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'Add many feeds at once', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				<form method="post" action="<?php echo $post_action; ?>">
					...
					<p>
						<label for="ai-bulk-urls" class="description"><?php esc_html_e( 'One feed address per line.', 'aggregate-it' ); ?></label>
			...
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'Blacklist', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				<form method="post" action="<?php echo $post_action; ?>">
					<input type="hidden" name="action" value="aggregate_it_save_blacklist">
					<?php wp_nonce_field( 'aggregate_it_save_blacklist' ); ?>
					<p>
						<label for="ai-blacklist" class="description"><?php esc_html_e( 'One word or domain per line. New articles mentioning any of these are skipped on import.', 'aggregate-it' ); ?></label>
			...
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'Backup &amp; restore', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				<form method="post" action="<?php echo $post_action; ?>">
					...
					<p>
						...
						<span class="description"><?php esc_html_e( 'Downloads your feeds, settings and blacklist as a JSON file (API keys are never included).', 'aggregate-it' ); ?></span>
					</p>
				</form>
				<form method="post" action="<?php echo $post_action; ?>" enctype="multipart/form-data">
					...
					<p>
						<label for="ai-config" class="description"><?php esc_html_e( 'Restore an Aggregate It backup, or import settings and feeds from another RSS aggregator export (JSON or WordPress XML).', 'aggregate-it' ); ?></label>
		...
		<div>
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'System info', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				...
				<p>
					<label for="ai-sysinfo" class="description"><?php esc_html_e( 'Copy for support:', 'aggregate-it' ); ?></label>
			...
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'Activity log', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				<?php if ( ! $events ) : ?>
			...
			<div class="postbox">
				<h2 class="hndle"><span><?php esc_html_e( 'Reset', 'aggregate-it' ); ?></span></h2>
				<div class="inside">
				<form method="post" action="<?php echo $post_action; ?>" class="ai-inline">
					...
					<select name="reset" id="ai-reset">
						...
						<option value="dupes_preview"><?php esc_html_e( 'Preview duplicate posts (no changes)', 'aggregate-it' ); ?></option>
						<option value="dupes"><?php esc_html_e( 'Trash duplicate posts (keep the oldest of each story)', 'aggregate-it' ); ?></option>
				...
				<p class="description"><?php esc_html_e( 'Your published posts are never deleted. “Clear the work queue” only removes import history.', 'aggregate-it' ); ?></p>
				</div>
			</div>
		</div>
	</div>
